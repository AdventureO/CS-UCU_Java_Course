...
public class ImmutableArrayListTest {
    ...
    public void testRemoveTooSmallIndexException() {
        ...
        Object expectedResult = new ImmutableArrayList(new Object[]{1, 2, 3, 4, 5, 6}).toString();
        assertEquals(expectedResult, arrayList.toString());
    }
    ...
    public void testSet() {
        ...
        assertEquals(-1, arrayList.getData()[2]);
    }
    ...
    public void testSetTooSmallIndexException() {
        ...
        Object expectedResult = new ImmutableArrayList(new Object[]{1, 2, 3, 4, 5, 6, 8}).toString();
        assertEquals(expectedResult, arrayList.toString());
    }
    ...
    public void testClear() {
        ...
        assertArrayEquals(null, arrayList.getData());
    }
